...
declare class ZString {
  static getZString(locKey: string): string;
  static getZStringAndReplace(locKey: string, stringSubstitutions: Array<any>): string;
}
...
declare class QEProject {
  ...
  getAudioEffectList(effectType?: number, unnamed_1?: boolean): Array<String>;
  ...
  getVideoEffectList(effectType?: number, unnamed_1?: boolean): Array<String>;
  getVideoTransitionByName(p0: string, unnamed_1?: boolean): QEVideoTransition;
  getVideoTransitionList(unnamed_0?: number, unnamed_1?: boolean): Array<String>;
